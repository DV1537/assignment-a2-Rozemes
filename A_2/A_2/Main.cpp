...
Shape **createArray(string fileName, int &size) {
	...
	while (currentRow < 1) {
		...
		if (nrOfNmbrsInLine > 0) {
			...
			{
			case 1:
				tempShapeArr[currentRow] = new Point(tempCoordArr, nrOfNmbrsInLine / 2);
				break;
			case 2:
				tempShapeArr[currentRow] = new Line(tempCoordArr, nrOfNmbrsInLine / 2);
				break;
			case 3:
				tempShapeArr[currentRow] = new Triangle(tempCoordArr, nrOfNmbrsInLine / 2);
				break;
			default:
